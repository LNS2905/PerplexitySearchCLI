...
How to configure OpenCode to use the `pplx-wrapper` Perplexity search skill.
...
Copy `skills/opencode/perplexity-search.md` into your OpenCode skills directory. The exact location depends on your OpenCode configuration.
